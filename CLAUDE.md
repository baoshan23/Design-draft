...
- 2026-05-21 — **b2c (`/[locale]/b2c`) `#multilingual` "20+ 种全球语言" yellow form panel** (`sections.css`, CSS-only, pushed fork `design-draft-local`). Four changes, all touching `.b2c-lang-aside` / its `.lang-request-card` (~3087) / the `.b2c-lang-panel` grid:
