          ...
          <div className="docs-content">
            ...
            <div className="code-block">
              <div className="code-header">
                ...
                >
                  {copiedBlock === 'ssh' ? t('docs.copied') : t('docs.copy')}
                </button>
              </div>
            ...
            <div className="code-block">
              <div className="code-header">
                ...
                >
                  {copiedBlock === 'install' ? t('docs.copied') : t('docs.copy')}
                </button>
              </div>
            ...
            <div className="code-block">
              <div className="code-header">
                ...
                >
                  {copiedBlock === 'verify' ? t('docs.copied') : t('docs.copy')}
                </button>
              </div>
...
systemctl status gcss`}</code></pre>
            ...
            <div className="code-block">
              <div className="code-header">
                ...
                >
                  {copiedBlock === 'url' ? t('docs.copied') : t('docs.copy')}
                </button>
              </div>
