...
const PAYMENT_BUBBLE_POSITIONS: { x: number; y: number; size: number; delay: number; duration: number }[] = [
  // Row 1 (y ~5)
  { x: 5,  y: 5,  size: 152, delay: 0,    duration: 6.0 },
  { x: 22, y: 8,  size: 128, delay: -1.4, duration: 6.6 },
  { x: 40, y: 4,  size: 144, delay: -2.2, duration: 7.0 },
  { x: 58, y: 6,  size: 120, delay: -0.6, duration: 5.6 },
  { x: 76, y: 4,  size: 160, delay: -1.8, duration: 6.2 },
  { x: 94, y: 8,  size: 128, delay: -0.4, duration: 6.8 },
  // Row 2 (y ~18)
  { x: 12, y: 20, size: 120, delay: -2.6, duration: 5.4 },
  { x: 30, y: 18, size: 152, delay: -1.0, duration: 7.2 },
  { x: 48, y: 22, size: 128, delay: -2.0, duration: 6.0 },
  { x: 66, y: 18, size: 144, delay: -0.8, duration: 5.8 },
  { x: 84, y: 22, size: 120, delay: -2.4, duration: 6.4 },
  // Row 3 (y ~34)
  { x: 4,  y: 34, size: 136, delay: -1.2, duration: 7.0 },
  { x: 22, y: 36, size: 168, delay: -0.2, duration: 5.6 },
  { x: 40, y: 32, size: 120, delay: -1.6, duration: 6.8 },
  { x: 58, y: 36, size: 144, delay: -2.8, duration: 5.4 },
  { x: 76, y: 32, size: 128, delay: -0.6, duration: 6.2 },
  { x: 94, y: 36, size: 152, delay: -2.0, duration: 6.6 },
  // Row 4 (y ~50)
  { x: 13, y: 50, size: 144, delay: -1.0, duration: 5.8 },
  { x: 31, y: 52, size: 120, delay: -2.2, duration: 6.4 },
  { x: 49, y: 48, size: 160, delay: -0.4, duration: 5.6 },
  { x: 67, y: 52, size: 128, delay: -1.6, duration: 6.0 },
  { x: 85, y: 50, size: 136, delay: -2.6, duration: 6.6 },
  // Row 5 (y ~66)
  { x: 4,  y: 66, size: 128, delay: -1.4, duration: 5.8 },
  { x: 22, y: 68, size: 152, delay: -0.2, duration: 6.0 },
  { x: 40, y: 64, size: 120, delay: -1.2, duration: 6.6 },
  { x: 58, y: 68, size: 168, delay: -2.4, duration: 7.0 },
  { x: 76, y: 66, size: 128, delay: -0.6, duration: 5.6 },
  { x: 94, y: 68, size: 144, delay: -1.8, duration: 6.2 },
  // Row 6 (y ~82)
  { x: 13, y: 82, size: 160, delay: -0.4, duration: 6.8 },
  { x: 31, y: 84, size: 128, delay: -2.6, duration: 5.4 },
  { x: 49, y: 80, size: 144, delay: -1.0, duration: 7.2 },
  { x: 67, y: 84, size: 120, delay: -2.0, duration: 6.0 },
  { x: 85, y: 82, size: 152, delay: -0.8, duration: 5.8 },
  // Row 7 (y ~94)
  { x: 4,  y: 94, size: 120, delay: -2.4, duration: 6.4 },
  { x: 22, y: 96, size: 144, delay: -1.2, duration: 7.0 },
  { x: 40, y: 94, size: 128, delay: -0.2, duration: 5.6 },
  { x: 58, y: 96, size: 152, delay: -1.6, duration: 6.8 },
  { x: 76, y: 94, size: 120, delay: -2.8, duration: 5.4 },
  { x: 94, y: 96, size: 136, delay: -0.6, duration: 6.2 },
  // Filler — break up rows so it doesn't read as a grid
  { x: 14, y: 12, size: 112, delay: -1.0, duration: 5.6 },
  { x: 51, y: 14, size: 120, delay: -2.2, duration: 6.4 },
  { x: 88, y: 14, size: 120, delay: -0.4, duration: 5.8 },
  { x: 9,  y: 42, size: 112, delay: -1.6, duration: 6.0 },
  { x: 88, y: 42, size: 112, delay: -2.6, duration: 5.4 },
  { x: 9,  y: 74, size: 112, delay: -1.4, duration: 6.6 },
  { x: 88, y: 74, size: 112, delay: -0.8, duration: 6.0 },
  { x: 50, y: 90, size: 120, delay: -2.0, duration: 5.8 },
];
